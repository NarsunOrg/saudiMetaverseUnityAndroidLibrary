...
{
	Exception_t* ___U3CfirstU3Ek__BackingFieldException = il2cpp_codegen_get_marshal_directive_exception("Cannot marshal field '<first>k__BackingField' of type 'ClothSphereColliderPair': Reference type field marshaling is not supported.");
